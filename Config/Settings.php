...
class Settings
{
     ...
     *
     * @param $data , can be an array or a file of the types yaml, json or php array, PHP will be executed!
    ...
    public static function init($data, $override = true)
    {
        ...
        if (is_string($data)) {
            $data = (new TreeFile())->read($data);
        }
        $settingsObj->data = $override
            ? $data
            : ArrayUtils::arrayMergeRecursiveDistinct($settingsObj->data, $data);
    }
